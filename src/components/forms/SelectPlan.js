...
export default function SelectPlan() {
  ...
  const [plan, setPlan] = useState(monthlyPrices);
  
  const toggle = () => {
    if (plan.type == "monthly") {
      setPlan(yearlyPrices);
    } else if (plan.type == "yearly") {
      setPlan(monthlyPrices);
    };
  }
    ...
    <>
      <div className="form--select-plan">
        <div className="plan">
          ...
          <span className="plan--price">{plan.arcade}</span>
          <span className="plan--annual-savings">{plan.yearlySavings}</span>
        </div>
        <div className="plan">
          ...
          <span className="plan--price">{plan.advanced}</span>
          <span className="plan--annual-savings">{plan.yearlySavings}</span>
        </div>
        <div className="plan">
          ...
          <span className="plan--price">{plan.pro}</span>
          <span className="plan--annual-savings">{plan.yearlySavings}</span>
        </div>
      </div>
      ...
      <div className="plan-toggle--text">
        <span>Monthly</span>
        <div className={plan.type} onClick={toggle}>
